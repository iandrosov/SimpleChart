...
<body>
<form name="alerts" action="demo_bar_chart.dsp" method="POST">

<table width="100%">
	<td class="menusection-Adapters">SimpleChart &gt; Demo Bar Chart</td>
</table>

%invoke SimpleChart.demo:createBarChart%
	<table width="100%">
	...
	%endif%
	<br>
	  <td class=heading colspan=9>Demo Bar Chart</td>
	<tr>
	<td valign=top>
	</table>

		<table width="100%">
		<IMG src=%value chart_file% alt="Demo Bar Chart">
		</table>
	...
	<tr>
	<tr>
	<td class=heading colspan=12>Demo Process Data</td>
	<tr>
	<td valign=top>
	</table>
	<script>
