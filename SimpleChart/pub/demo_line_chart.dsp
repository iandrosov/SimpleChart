...
<body>
<form name="alerts" action="demo_line_chart.dsp" method="POST">

<table width="100%">
	<td class="menusection-Adapters">SimpleChart &gt; Demo Line Chart</td>
</table>

%invoke SimpleChart.demo:createLineChart%
	<table width="100%">
	...
	%endif%
	<br>
	  <td class=heading colspan=9>Demo Line Chart</td>
	<tr>
	<td valign=top>
	</table>

		<table width="100%">
		<IMG src=%value chart_file% alt="Demo Line Chart">
		</table>
	...
	<tr>
	<tr>
	<td class=heading colspan=12>Demo Process Time Stats Data</td>
	<tr>
	<td valign=top>
	</table>
	<script>
