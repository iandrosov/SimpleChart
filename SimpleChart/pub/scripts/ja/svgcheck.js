...
if(confirm('Adobe SVG Viewer がインストールされていません。ダウンロードしますか?'))
...
if(window.svgInstalled)
	...
	if(navigator.appName=='Netscape') {
		document.writeln('<p>このページを表示するには SVG Viewer が必要です。');
		document.writeln('<a href="'+getSVGInstallPage()+'">ここ</a>をクリックして詳細を参照してください。</p>');
		}
	else
	...
	document.writeln('<p>このページを表示するには SVG Viewer が必要です。現在、使用中のブラウザで使用できる Adobe SVG Viewer ');
	document.writeln('がインストールされていません。 ');
	document.writeln('<a href="'+svgInfoPage+'">ここ</a>をクリックして詳細を参照してください。</p>');
	}
}
